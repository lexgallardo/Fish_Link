...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows === 1) {
        ...
        if (password_verify($password, $user['password'])) {
            ...
            header("Location: customer_inventory.php"); // Redirect customer to inventory
            exit();
        } else {
...
<html>
<head>
    <title>Customer Sign In - FishLink</title>
...
<div class="sidebar">
    ...
    <a href="signin_customer.php" class="active"><i>🔐</i><span>Sign In</span></a>
    <a href="signup_customer.php"><i>📝</i><span>Sign Up</span></a>
...
<div class="main">
    <form method="post">
        ...
        <div class="link-bottom">
            Don’t have an account? <a href="signup_customer.php">Sign up</a>
        </div>
    </form>
</div>
