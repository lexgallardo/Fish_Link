...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 19, 2025 at 10:24 AM
...
CREATE TABLE `users` (
  ...
  `password` varchar(255) NOT NULL,
  `role` enum('admin','fisherman') NOT NULL DEFAULT 'fisherman',
...
(1, 'Admin', 'Account', 'admin', 'admin@fishlink.com', '$2y$10$9NGs6yMJ/gdTREUPpzj90.O8m1koZ3DaOAlV.IBQG/Z/tRufZ2BPK', 'admin', '2025-07-12 17:26:49');
