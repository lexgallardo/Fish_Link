...
$db_pass = "";             // your database password ("" if none in XAMPP)
$db_name = "FishLink_DB";  // your database name
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $role = 'fisherman'; // 🔐 Always set to fisherman
    ...
    if ($password !== $confirm) {
        ...
        if ($result->num_rows > 0) {
            ...
            $insert->bind_param("ssssss", $first, $last, $username, $email, $hashed, $role);
            if ($insert->execute()) {
